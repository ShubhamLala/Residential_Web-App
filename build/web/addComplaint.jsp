<%-- 
    ...
    Created on : 13-Sep-2020, 7:18:39 pm
    Author     : shubh
--%>
         ...
         <form method="POST" action="">
                    <div class="form-row">
                      <div class="form-group col-md-12">
                        <label for="complaint">Insert Complaint</label>
                        <textarea class="form-control" id="complaint" name="complaint" rows="10"></textarea>
                      </div>
                    </div>
                    <input type="submit" id="submit" value="Add Complaint" name="submit" class="btn btn-info">
                  </form>
          </div>
    <div class="col-md-3"></div>
</div>
        ...
        pst = con.prepareStatement("INSERT into complaints(block,flatnumber,complaint,status) values(?,?,?,?)");
        ...
        <%
        String site = new String("http://localhost:8080/Residential/complaints.jsp?block="+block+"&flat="+flatnumber);
