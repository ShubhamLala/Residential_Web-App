...
<html>
    ...
    %>
        ...
        <h1 class="mt-5">Your Complaints</h1>
        <a class="btn btn-danger mt-2 mb-5" id="addButton" href="addComplaint.jsp?block=<%= block%>&flat=<%= flatnumber%>">Register A Complaint</a>
        <table class="table">
            <thead>
            <th>Complaint Id</th>
            <th>Complaint</th>
        ...
        String sql = "select * from complaints where block='" + block + "' and flatnumber=" + flatnumber;
        try {
